...
const lightColorScheme = ColorScheme(
  ...
  primaryContainer: Color(0xFF74FAC8),
  ...
  inversePrimary: Color(0xFF54DDAD),
...
const darkColorScheme = ColorScheme(
  ...
  primary: Color(0xFF54DDAD),
  onPrimary: Color(0xFF003828),
  primaryContainer: Color(0xFF00513B),
  onPrimaryContainer: Color(0xFF74FAC8),
  ...
  shadow: Color(0xFF000000),
  surfaceTint: Color(0xFF54DDAD),
  outlineVariant: Color(0xFF404944),
  scrim: Color(0xFF000000),
);

class Colours {
  static const Color mainColor = Color(0xFF75FBC9); // 碧蓝色

  static const Color mineralPurple = Color(0xFFB5B6C0); // 矿紫色

  static const Color lilac = Color(0xFF958CF8); // 紫丁香色
